...
- Developed a lightweight analytics platform framework to facilitate rapid dashboard construction using Plotly/Dash, FastAPI, Redis and Docker.
...
- Developed performance metrics for benchmarking the forecasting tool and create reports analyzing its efficacy for various business use-cases
- Analyzed economic and internal demand time-series data and produced high-quality reports and visualizations in RMarkdown
...
- Wrote internal training materials for Apache Kafka with Python; developed internal packages and APIs; worked with Hive and Postgres databases.
